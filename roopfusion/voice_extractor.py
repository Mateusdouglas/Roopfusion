...
from roopfusion.typing import ModelSet, AudioChunk, Audio
...
def get_voice_extractor() -> Any:
	...
	with thread_lock():
		...
		if VOICE_EXTRACTOR is None:
			...
			VOICE_EXTRACTOR = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(roopfusion.globals.execution_device_id, roopfusion.globals.execution_providers))
