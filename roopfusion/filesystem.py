...
def get_temp_frames_pattern(target_path : str, temp_frame_prefix : str) -> str:
	...
	return os.path.join(temp_directory_path, temp_frame_prefix + '.' + roopfusion.globals.temp_frame_format)
...
def clear_temp(target_path : str) -> None:
	...
	if not roopfusion.globals.keep_temp and is_directory(temp_directory_path):
