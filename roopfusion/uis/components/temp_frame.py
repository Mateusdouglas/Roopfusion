...
from roopfusion.typing import TempFrameFormat
...
def render() -> None:
	...
	TEMP_FRAME_FORMAT_DROPDOWN = gradio.Dropdown(
		...
		choices = roopfusion.choices.temp_frame_formats,
		value = roopfusion.globals.temp_frame_format,
...
def update_temp_frame_format(temp_frame_format : TempFrameFormat) -> None:
	roopfusion.globals.temp_frame_format = temp_frame_format
