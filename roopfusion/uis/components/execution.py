...
from roopfusion.processors.frame.core import clear_frame_processors_modules
...
def render() -> None:
	...
	EXECUTION_PROVIDERS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		value = encode_execution_providers(roopfusion.globals.execution_providers)
	)
...
def update_execution_providers(execution_providers : List[str]) -> gradio.CheckboxGroup:
	...
	roopfusion.globals.execution_providers = decode_execution_providers(execution_providers)
