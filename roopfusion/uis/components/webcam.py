...
from roopfusion.audio import create_empty_audio_frame
from roopfusion.common_helper import is_windows
from roopfusion.content_analyser import analyse_stream
from roopfusion.filesystem import filter_image_paths
from roopfusion.typing import VisionFrame, Face, Fps
from roopfusion.face_analyser import get_average_face
from roopfusion.processors.frame.core import get_frame_processors_modules, load_frame_processor_module
from roopfusion.ffmpeg import open_ffmpeg
from roopfusion.vision import normalize_frame_color, read_static_images, unpack_resolution
from roopfusion.uis.typing import StreamMode, WebcamMode
from roopfusion.uis.core import get_ui_component, get_ui_components
...
def start(webcam_mode : WebcamMode, webcam_resolution : str, webcam_fps : Fps) -> Generator[VisionFrame, None, None]:
	roopfusion.globals.face_selector_mode = 'one'
	roopfusion.globals.face_analyser_order = 'large-small'
...
def multi_process_capture(source_face : Face, webcam_capture : cv2.VideoCapture, webcam_fps : Fps) -> Generator[VisionFrame, None, None]:
	with tqdm(desc = wording.get('processing'), unit = 'frame', ascii = ' =', disable = roopfusion.globals.log_level in [ 'warn', 'error' ]) as progress:
		with ThreadPoolExecutor(max_workers = roopfusion.globals.execution_thread_count) as executor:
			futures = []
