...
from roopfusion.processors.frame.typings import FaceDebuggerItem, FaceEnhancerModel, FaceSwapperModel, FrameColorizerModel, FrameEnhancerModel, LipSyncerModel
from roopfusion.uis.core import get_ui_component, register_ui_component
...
def render() -> None:
	...
	FACE_DEBUGGER_ITEMS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		visible = 'face_debugger' in roopfusion.globals.frame_processors
	)
	FACE_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_enhancer' in roopfusion.globals.frame_processors
	)
	...
	FACE_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_swapper' in roopfusion.globals.frame_processors
	)
	FRAME_COLORIZER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'frame_colorizer' in roopfusion.globals.frame_processors
	)
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'frame_enhancer' in roopfusion.globals.frame_processors
	)
	...
	LIP_SYNCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'lip_syncer' in roopfusion.globals.frame_processors
	)
