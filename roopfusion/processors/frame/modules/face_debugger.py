...
from roopfusion import config, process_manager, wording
...
from roopfusion.face_helper import warp_face_by_face_landmark_5, categorize_age, categorize_gender
from roopfusion.face_store import get_reference_faces
from roopfusion.content_analyser import clear_content_analyser
from roopfusion.typing import Face, VisionFrame, UpdateProgress, ProcessMode, QueuePayload
from roopfusion.vision import read_image, read_static_image, write_image
from roopfusion.processors.frame.typings import FaceDebuggerInputs
from roopfusion.processors.frame import globals as frame_processors_globals, choices as frame_processors_choices
...
def debug_face(target_face : Face, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	if 'face-mask' in frame_processors_globals.face_debugger_items:
		...
		if 'box' in roopfusion.globals.face_mask_types:
			box_mask = create_static_box_mask(crop_vision_frame.shape[:2][::-1], 0, roopfusion.globals.face_mask_padding)
