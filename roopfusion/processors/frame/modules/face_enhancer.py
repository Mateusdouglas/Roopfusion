...
from roopfusion.face_analyser import get_many_faces, clear_face_analyser, find_similar_faces, get_one_face
from roopfusion.face_masker import create_static_box_mask, create_occlusion_mask, clear_face_occluder
...
from roopfusion.thread_helper import thread_lock, thread_semaphore
from roopfusion.typing import Face, VisionFrame, UpdateProgress, ProcessMode, ModelSet, OptionsWithModel, QueuePayload
from roopfusion.common_helper import create_metavar
from roopfusion.filesystem import is_file, is_image, is_video, resolve_relative_path
from roopfusion.download import conditional_download, is_download_done
from roopfusion.vision import read_image, read_static_image, write_image
from roopfusion.processors.frame.typings import FaceEnhancerInputs
...
def enhance_face(target_face: Face, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	box_mask = create_static_box_mask(crop_vision_frame.shape[:2][::-1], roopfusion.globals.face_mask_blur, (0, 0, 0, 0))
	crop_mask_list =\
	[
		box_mask
	]
