...
from roopfusion.typing import FaceLandmark68, VisionFrame, Mask, Padding, FaceMaskRegion, ModelSet
...
def get_face_occluder() -> Any:
	...
	with thread_lock():
		...
		if FACE_OCCLUDER is None:
			...
			FACE_OCCLUDER = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(roopfusion.globals.execution_device_id, roopfusion.globals.execution_providers))
...
def get_face_parser() -> Any:
	...
	with thread_lock():
		...
		if FACE_PARSER is None:
			...
			FACE_PARSER = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(roopfusion.globals.execution_device_id, roopfusion.globals.execution_providers))
	return FACE_PARSER
