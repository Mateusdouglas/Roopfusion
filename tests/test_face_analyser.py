...
from roopfusion.face_analyser import pre_check, clear_face_analyser, get_one_face
from roopfusion.typing import Face
from roopfusion.vision import read_static_image
...
def before_each() -> None:
	roopfusion.globals.face_detector_score = 0.5
	roopfusion.globals.face_landmarker_score = 0.5
	roopfusion.globals.face_recognizer_model = 'arcface_inswapper'
	clear_face_analyser()


def test_get_one_face_with_retinaface() -> None:
	roopfusion.globals.face_detector_model = 'retinaface'
	roopfusion.globals.face_detector_size = '320x320'
...
def test_get_one_face_with_scrfd() -> None:
	roopfusion.globals.face_detector_model = 'scrfd'
...
def test_get_one_face_with_yoloface() -> None:
	roopfusion.globals.face_detector_model = 'yoloface'
	roopfusion.globals.face_detector_size = '640x640'
...
def test_get_one_face_with_yunet() -> None:
	roopfusion.globals.face_detector_model = 'yunet'
	roopfusion.globals.face_detector_size = '640x640'
