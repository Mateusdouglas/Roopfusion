...
from roopfusion.filesystem import get_temp_directory_path, create_temp, clear_temp
from roopfusion.download import conditional_download
from roopfusion.ffmpeg import extract_frames, read_audio_buffer
...
def before_each() -> None:
	...
	roopfusion.globals.temp_frame_format = 'jpg'
...
def test_extract_frames_with_trim_start() -> None:
	roopfusion.globals.trim_frame_start = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_start_and_trim_end() -> None:
	roopfusion.globals.trim_frame_start = 124
	roopfusion.globals.trim_frame_end = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_end() -> None:
	roopfusion.globals.trim_frame_end = 100
	data_provider =\
	[
		('.assets/examples/target-240p-25fps.mp4', 120),
		('.assets/examples/target-240p-30fps.mp4', 100),
